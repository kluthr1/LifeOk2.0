...
<div id="skipnav"><a href="#maincontent">Skip to main content</a></div>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="page-scroll">
                        <a href="eds.php">Edit Settings</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
	...
	<div class="login-form-1" style="width: 300px;">
		<form id="register-form" name = "register-form" class="text-left" method="POST" action = "mail/send.php"  novalidate="novalidate">
				...
				<div class="login-group">
                 ...
                 <!--<input type="hidden" id="name" name="name" value="" />
                   <input type="hidden" id="email" name= "email" value="" />
                    ...
                    <input type="hidden" id="emailof" name = "emailof" value="" />
     ...
     <script>
         function redirect(){
           ...
           // document.getElementById('name').value = localStorage.getItem('name');
            ...
            // document.getElementById('emailof').value = localStorage.getItem('emailof');
